...
export const style = StyleSheet.create({
  ...
  header: { paddingHorizontal: 24, paddingTop: 52, paddingBottom: 40, overflow: 'hidden' },
  backBtn: {
  ...
  modalTitle: { fontSize: 16, fontWeight: '700', color: themas.color.primary, marginBottom: 16 },
  modalOption: {
    flexDirection: 'row', alignItems: 'center',
    paddingVertical: 14,
